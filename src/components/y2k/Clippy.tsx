    ...
    >
      <div className="y2k-clippy-bubble" aria-live="polite">
        {says === "intro" ? (
          <>
            <p style={{ margin: 0 }}>
              It looks like you&apos;re trying to hire a co-op student! Would
              you like help?
            </p>
            <p style={{ margin: "6px 0 0" }}>
              That&apos;s <strong>{IDENTITY.name}</strong> — {IDENTITY.headline}
              , Computer Science at Waterloo, {COOP_TERMS.length} co-op terms
              in.
            </p>
          </>
        ) : null}
        ...
        {says === "available" ? (
          <p style={{ margin: 0 }}>
            <strong>{IDENTITY.availability}.</strong> He&apos;s in{" "}
            {IDENTITY.location}. The CONTACT ME app has e-mail functionality to
            reach out.
          </p>
        ) : null}
